...
const ANIM = {
  ...
  chicken:{vb:'0 0 280 280', inner:'<path d="M104,84 Q112,52 122,82 Q132,50 142,82 Q152,50 162,82 Q172,54 178,86" fill="none" stroke="#d64f3f" stroke-width="14" stroke-linecap="round"/><ellipse cx="140" cy="170" rx="78" ry="74" fill="#f4f4ef"/><ellipse cx="140" cy="120" rx="44" ry="42" fill="#fbfbf7"/><circle cx="158" cy="114" r="9" fill="#1d2321"/><polygon points="180,120 218,130 180,140" fill="#d9893b"/><path d="M150,142 Q160,164 144,166" fill="#d64f3f"/><path d="M72,168 Q44,158 66,200" fill="#dce2e2"/><path d="M122,238 L114,262" stroke="#d9893b" stroke-width="8"/><path d="M158,238 L166,262" stroke="#d9893b" stroke-width="8"/>'},
  chickenT:{vb:'0 0 280 280', inner:'<path d="M104,84 Q112,52 122,82 Q132,50 142,82 Q152,50 162,82 Q172,54 178,86" fill="none" stroke="#b33c2c" stroke-width="14" stroke-linecap="round"/><ellipse cx="140" cy="170" rx="78" ry="74" fill="#d9893b"/><ellipse cx="140" cy="120" rx="44" ry="42" fill="#e3a05a"/><circle cx="158" cy="114" r="9" fill="#1d2321"/><polygon points="180,120 218,130 180,140" fill="#b3621f"/><path d="M150,142 Q160,164 144,166" fill="#b33c2c"/><path d="M72,168 Q44,158 66,200" fill="#e9c79c"/><path d="M122,238 L114,262" stroke="#b3621f" stroke-width="8"/><path d="M158,238 L166,262" stroke="#b3621f" stroke-width="8"/>'},
  bee:{vb:'0 0 280 280', inner:'<ellipse cx="96" cy="108" rx="42" ry="30" fill="#dceeed"/><ellipse cx="184" cy="108" rx="42" ry="30" fill="#dceeed"/><ellipse cx="140" cy="154" rx="78" ry="66" fill="#d9893b"/><rect x="98" y="98" width="18" height="106" fill="#1d2321"/><rect x="136" y="92" width="18" height="118" fill="#1d2321"/><rect x="174" y="104" width="18" height="96" fill="#1d2321"/><circle cx="112" cy="148" r="8" fill="#fff"/><circle cx="164" cy="148" r="8" fill="#fff"/><path d="M118,214 Q140,228 162,214" stroke="#1d2321" stroke-width="5" fill="none"/>'},
};
...
const WORKS = [
  ...
  {dir:'mobbing-explainer',         band:'orange', badge:'同調圧力',      t1:'群れはなぜ、',       t2:'一匹を狩る<span class="q">？</span>', layout:'center', gap:30, chars:[S('chicken',236,236),S('chickenT',280,280),S('chicken',236,236)]},
  {dir:'dunbar-explainer',          band:'orange', badge:'ダンバー数150',  t1:'人を増やすほど、',   t2:'急に壊れる<span class="q">？</span>', layout:'right', gap:16, chars:[S('chimp',332,332)]},
  {dir:'rewilding-explainer',       band:'green',  badge:'再野生化',       t1:'固まった組織は、',   t2:'号令では動かない', layout:'right', gap:16, chars:[S('wolf',332,332)]},
  {dir:'habit-explainer',           band:'orange', badge:'習慣の科学',     t1:'続かないのは、',     t2:'意志のせい<span class="q">？</span>', layout:'right', gap:16, chars:[S('rat',332,332)]},
  {dir:'swarm-explainer',           band:'green',  badge:'群れの意思決定',  t1:'女王は、決めない。', t2:'なぜ最良を選べる<span class="q">？</span>', layout:'center', gap:30, chars:[S('bee',224,224),S('bee',224,224),S('bee',224,224)]},
  {dir:'hierarchy-explainer',       band:'green',  badge:'階層設計',       t1:'全員同じに揃えると、', t2:'どこかの層が死ぬ', layout:'center', gap:36, chars:[S('ant',236,236),S('wolf',268,268),S('ant',236,236)]},
];
