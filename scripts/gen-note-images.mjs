...
const EMOJI = {
  ...
  'attribution-ethology':'🐦','fear-kills-learning-dialogue':'🦉🐤','reward-trap-dialogue':'🦉🐤','controllability-dialogue':'🦉🐤','five-types-ethology-dialogue':'🦉🐤','wolf-type-dialogue':'🦉🐤','ant-type-dialogue':'🦉🐤','chimp-type-dialogue':'🦉🐤','bonobo-type-dialogue':'🦉🐤','hyena-type-dialogue':'🦉🐤',
...
const CAT = {
  ...
  'five-types-ethology':GREEN,'five-types-ethology-dialogue':GREEN,'wolf-type-dialogue':GREEN,'ant-type-dialogue':GREEN,'chimp-type-dialogue':GREEN,'bonobo-type-dialogue':GREEN,'hyena-type-dialogue':GREEN,'wolf-ethology':GREEN,'ant-ethology':GREEN,'chimp-ethology':GREEN,'bonobo-ethology':GREEN,
...
const TITLE = {
  ...
  'wolf-type-dialogue':'〔対話〕なぜ最強の狩猟チームは、ボーナスで壊れるのか',
  'ant-type-dialogue':'〔対話〕「強い社風」ほど、なぜ方向転換に弱いのか',
  'chimp-type-dialogue':'〔対話〕社内政治がうまい人が出世する組織は、なぜ学ばなくなるのか',
  'bonobo-type-dialogue':'〔対話〕仲が良くて風通しも良いのに、なぜ伸びないのか',
  'hyena-type-dialogue':'〔対話〕数字で締める組織が、なぜ最初に伸びて、最後に壊れるのか',
