...
const CAT = {
  ...
  'crowding-out':ORANGE,'attribution-ethology':ORANGE,'recruitment-ethology':ORANGE,'negotiation-ethology':ORANGE,'unfairness-cost':ORANGE,
  'controllability':RED,'fear-kills-learning':RED,'one-trial-ethology':RED,
  ...
  'five-types-ethology':GREEN,'wolf-ethology':GREEN,'ant-ethology':GREEN,'chimp-ethology':GREEN,'bonobo-ethology':GREEN,
...
function html(title, emoji, [c1, c2]) {
...
<div class="brand"><span class="s">🐾 動物行動学シリーズ</span><span class="u">zumenseki.github.io/doubutsu-soshikiron</span></div>
</div></body></html>`;
}
...
for (const slug of slugs) {
  ...
  writeFileSync(tmpHtml, html(title, emoji, col), 'utf8');
